...
Model_Polynomial <- ksvm(label~ ., data = mnistTrain, scale = FALSE, kernel = "polydot")
Eval_Polynomial <- predict(Model_Polynomial, mnistTest)

#confusion matrix - Polynomial Kernel
confusionMatrix(Eval_Polynomial,mnistTest$label)
