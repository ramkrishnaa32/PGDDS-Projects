...
ggplot(data_problem1, aes(x = data_problem1$Pickup.point, fill= as.factor(data_problem1$Status))) + 
geom_bar() + coord_polar(theta = "y", start=0)+ labs( y = "Number of Requests", x = "", fill = "Status")
