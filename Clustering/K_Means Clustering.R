...
### Modeling ###
clus <- kmeans(RFM_norma1, centers = 3, nstart = 50)
# centers - no. of clusters
# nstart - Algorithm will rum 50 times choosing 50 initial different centroids 
# The most optimal grouping
str(clus)

clus5 <- kmeans(RFM_norma1, centers = 5, nstart = 50)
